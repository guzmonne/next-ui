(function (nx, global) {
    ...
    var topologyData = {
        nodes: [
            {"id": 0, "x": 410, "y": 100, "name": "12K-1", status: 'warning'},
            {"id": 1, "x": 410, "y": 280, "name": "12K-2", status: 'normal'},
            {"id": 2, "x": 660, "y": 280, "name": "Of-9k-03", status: 'normal'},
            {"id": 3, "x": 660, "y": 100, "name": "Of-9k-02", status: 'error'},
            {"id": 4, "x": 180, "y": 190, "name": "Of-9k-01", status: 'warning'}
        ],
        links: [
            {"source": 0, "target": 1},
            {"source": 1, "target": 2},
