...
function define(type, parent, members, options = {} /* Hack Parameter*/) {
  ...
  // Refactor static variable to avoid "Binding static in strict mode" error on compile.
  var _static = members.static || false;
...
/*
  We move this declarations to nx-es2015.js file.
 */
//nx.Object = NXObject;
//nx.define = define;
//nx.classes = classes;
