...
// Saved the ObservableObject on its own module.
// Change define() call to use Observable instead of nx.Observable

export var ObservableObject = nx.define('nx.data.ObservableObject', Observable, {
  methods: {
    init: function (data) {
      this.inherited();
      this._data = data || {};
