...
import {Dictionary} from './Dictionary-es2015.js';
...
// Export ObservableDictionary into its own module

export var ObservableDictionary = nx.define('nx.data.ObservableDictionary', Dictionary, {
  mixins: Observable,
  events: ['change'],
  methods: {
    /**
